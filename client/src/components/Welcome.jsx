            ...
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    <button 
                        ...
                        <p className="text-white text-bold text-base">
                          { Boolean(currentAccount) ? 'Disconnect Wallet' : 'Connect Wallet' }
                        </p>
                    </button>
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                    ...
                    <form className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
                        ...
                        <Input placeholder="Keword {GIF}" name="keyword" type="text" handleChange={handleChange}/>
